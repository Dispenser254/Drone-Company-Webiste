...
const TestimonialSection = () => {
  ...
  return (
    <motion.div
      ref={targetRef}
      style={{ scale, opacity }}
      className="h-[230vh] sm:h-[200vh] lg:h-[120vh] border-t rounded-t-[50px] bg-sky-500 flex justify-center items-center px-5 lg:px-10 py-5"
    >
      <motion.div
        ref={ref}
      ...
      >
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-primary text-orange-400 mb-12">
          What Our
          <br /> Clients Say
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-full gap-x-10 lg:gap-x-14 px-8 gap-y-5 overflow-hidden">
