...
import homeUrl from "../assets/img/hero_home_01.jpg";
        ...
        <div className="border border-neutral-500 divide-y divide-neutral-500 lg:rounded-br-[50px] rounded-[50px]">
            ...
            >
              ...
              <div className="px-3 font-secondary text-white text-justify py-3">
                ...
                <p>
                  ...
                  delivery solutions, we have the expertise and technology to
                  meet your needs. Partner with us to experience the future of
                  flight today.
                </p>
              </div>
              <motion.button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 divide-x divide-neutral-500 h-[80vh] lg:h-[100vh] w-full">
            <motion.div
              ...
              initial={{ opacity: 0, y: 200 }}
              animate={
                isInView1 ? { opacity: 1, y: 0 } : { opacity: 0, y: 200 }
              }
              transition={{
                duration: 2,
                ease: [0.17, 0.55, 0.55, 1],
            ...
            >
              ...
              <div className="px-5 font-secondary text-white text-justify py-3">
                ...
                <p className="mt-3">
                  ...
                  inspection, and delivery. Our dedicated team of experts
                  ensures that every project is executed with precision and
                  excellence. Partner with us and experience the future of
                  flight today.
                </p>
              </div>
              <motion.button
